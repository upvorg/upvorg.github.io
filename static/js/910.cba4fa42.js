 ...
 */var h=E(8588),X=Symbol.for("react.element"),Z=Symbol.for("react.fragment"),A=Object.prototype.hasOwnProperty,se=h.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,ce={key:!0,ref:!0,__self:!0,__source:!0};function H(j,I,M){var x,$={},C=null,F=null;M!==void 0&&(C=""+M),I.key!==void 0&&(C=""+I.key),I.ref!==void 0&&(F=I.ref);for(x in I)A.call(I,x)&&!ce.hasOwnProperty(x)&&($[x]=I[x]);if(j&&j.defaultProps)for(x in I=j.defaultProps,I)$[x]===void 0&&($[x]=I[x]);return{$$typeof:X,type:j,key:C,ref:F,props:$,_owner:se.current}}s.Fragment=Z,s.jsx=H,s.jsxs=H},8935:(z,s)=>{/**
 * @license React
